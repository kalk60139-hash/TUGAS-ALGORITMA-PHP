    ...
    if ($jumlah_suku > 0 && $jumlah_suku <= 50) {
        switch ($jenis_deret) {
            ...
            case 'kuadrat':
                ...
                $keterangan = "Menampilkan $jumlah_suku bilangan kuadrat pertama (n虏)";
                break;
...
<body>
    <div class="container">
        <h1>馃敘 Program Deret Bilangan</h1>
        <p class="subtitle">Tampilkan berbagai jenis deret bilangan dengan mudah</p>
        
        <?php if (isset($error)): ?>
            <div class="alert alert-danger">鉂� <?php echo $error; ?></div>
        <?php endif; ?>
        ...
        <div class="form-section">
            <form method="POST" action="" id="formDeret">
                <div class="form-group">
                    <label for="jenis_deret">馃搳 Pilih Jenis Deret</label>
                ...
                <div class="form-group">
                    <label for="jumlah_suku">馃敘 Jumlah Suku (1-50)</label>
                ...
                <button type="submit" class="btn btn-primary">馃殌 Tampilkan Deret</button>
            </form>
        </div>
